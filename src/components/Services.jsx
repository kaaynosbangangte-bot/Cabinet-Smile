...
function Services() {
    const services = [
        ...
        },
        {
            ...
            title: 'Orthodontie',
            description: 'Appareils bucco-dentaires et aligneurs invisibles pour corriger votre dentition.'
        },
        {
            image: '/images/implantologie.jpg',
            title: 'Implantologie',
            description: 'Implants bucco-dentaires durables pour remplacer les dents manquantes.'
        },
        {
        ...
        },
        {
            ...
            description: 'Approche douce et rassurante pour les soins bucco-dentaires des plus jeunes.'
        }
    ]
